...
class TestCtrl:
    """Tests for Control namelist."""

    def test_any_control(self):
        """Test ANY control logic."""
        ctrl = Control(id="ALARM", function_type=ControlFunction.ANY, input_id=["SD_1", "SD_2"])
    ...
    def test_ctrl_validation_any_requires_list(self):
        ...
        with pytest.raises(ValidationError, match="multiple INPUT_ID"):
            Control(id="BAD", function_type=ControlFunction.ANY, input_id="SD_1")
